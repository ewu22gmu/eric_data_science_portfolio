...
Repository containing portfolio of data science projects completed by me. Presented in the form of jupyter Notebooks.
...
Steps: 
  1. Data cleansing of textual features
  2. Feature engineering of market measures
  3. Allignment of social media posts and the associated stock market data
  4. Significance tests between textual data and stock market movement
...
Steps: 
  ...
  2. Using the NLTK package to transform text corpora for each period of poetry
  3. Applying NLP tools to derive and describe the poetry
...
Steps: 
  1. Initialization of the agent population 
  2. Initialization of data structures
  3. Evolution and manufacturing operations at each tick to generate data
...
If you liked my work, please feel free to reach out to me at [ericyywu247\@gmail.com](mailto:ericyywu247@gmail.com){.email} about the portfolio, work opportunities, or collaboration, shoot an email.
